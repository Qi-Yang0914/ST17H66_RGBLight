...
//**************************************************************************************************
//						《当前年月日算出周几》(Year_h:年高位（20）,Year_l:年低位(当前年-2000))
//*************************************************************************************************
...
//**************************************************************************************************
//						《根据U32秒算出当前年月日时分秒》(time:U32秒，LC_RTC8563_RTCTime *t:年月日)
//*************************************************************************************************
void my_rtc_localtime(u32 time,LC_RTC8563_RTCTime *t){
	...
	time /= 60;
	Pass4year=((unsigned int)time / (1461L * 24L));  //取过去多少个四年，每四年有1461*24小时
	...
	t->dev_hour=(int)((time + 8) % 24);   //小时数
	time = (time + 8)/24;  //一年中剩下的天数
	time++;      //假定为闰年
